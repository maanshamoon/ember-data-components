...
;define("dummy/ember-data-components/tests/addon.lint-test", [], function () {
  ...
  QUnit.test('addon/components/query-record.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'addon/components/query-record.js should pass ESLint\n\n12:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n13:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n14:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)');
  });
  QUnit.test('addon/components/query.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'addon/components/query.js should pass ESLint\n\n12:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n13:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)\n14:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)');
  });
});
...
;define("dummy/templates/index", ["exports"], function (_exports) {
  ...
  var _default = Ember.HTMLBars.template({
    "id": "9gLw/YIH",
    "block": "{\"symbols\":[],\"statements\":[[1,[28,\"docs-hero\",null,[[\"prefix\",\"heading\",\"byline\"],[\"EmberData\",\"Components\",\"A set of components that provides an interface for retrieving records with Ember Data directly from templates.\"]]],false]],\"hasEval\":false}",
    "meta": {
